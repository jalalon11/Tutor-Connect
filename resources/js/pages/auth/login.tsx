...
export default function Login({
    ...
    return (
        ...
        >
            ...
            {status && (
                <div className="mb-4 text-center text-sm font-medium text-green-600 bg-green-50 dark:bg-green-900/20 py-2 rounded-lg border border-green-100 dark:border-green-800">
                    {status}
                </div>
            )}
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <a
                                ...
                                className="flex items-center justify-center gap-2 h-10 px-4 rounded-lg border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-sm font-medium"
                            >
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-2 h-10 px-4 rounded-lg bg-[#1877F2] hover:bg-[#166FE5] text-white transition-colors text-sm font-medium"
                            >
