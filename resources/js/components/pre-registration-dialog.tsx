...
export default function PreRegistrationDialog({ open, onOpenChange }: PreRegistrationDialogProps) {
    const handleEmailClick = () => {
        // Open pre-register page in new tab
        window.open('/pre-register', '_blank');
        onOpenChange(false);
    };
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader className="text-center sm:text-center">
                    ...
                    <DialogDescription>
                        Be among the first to join TutorConnect when we launch
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex flex-col gap-3 mt-4">
                    {/* Google */}
                    <a
                        href="/auth/google/redirect?type=preregister"
                    ...
                    {/* Facebook */}
                    <a
                        href="/auth/facebook/redirect?type=preregister"
