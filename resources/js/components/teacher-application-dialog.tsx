...
interface TeacherApplicationDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
}

export default function TeacherApplicationDialog({ open, onOpenChange }: TeacherApplicationDialogProps) {
                ...
                {step === 'provider' ? (
                    <>
                        <DialogHeader className="text-center sm:text-center">
                            ...
                            <DialogDescription>
                                Apply to join our community of expert tutors on TutorConnect
                            </DialogDescription>
                        </DialogHeader>
                    ...
                    <>
                        <DialogHeader>
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <DialogTitle>Apply with Email</DialogTitle>
                                    <DialogDescription>
                                        Fill in your details to apply as a tutor
                                    </DialogDescription>
                                </div>
                            </div>
                        </DialogHeader>
